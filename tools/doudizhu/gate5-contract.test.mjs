...
test('offline Worker URLs exactly match runtime requests', async () => {
  ...
  for (const url of [
    '/assets/js/doudizhu/ai-worker.js?v=20260801g8b',
    '/assets/js/doudizhu/net.js?v=20260801g8b',
    '/assets/js/doudizhu/ai-eval-worker.js?v=20260801g8b',
  ]) {
    assert.ok(manifest.hard.some(asset => asset.url === url) || manifest.master.some(asset => asset.url === url), url);
  }
  assert.match(runtime, /ai-worker\.js\?v=20260801g8b/);
  assert.match(worker, /net\.js\?v=20260801g8b/);
  assert.match(worker, /ai-eval-worker\.js\?v=20260801g8b/);
});
