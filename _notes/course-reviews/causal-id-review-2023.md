...
keywords: ["计量因果识别方法课程测评", "因果识别", "causal identification", "黄开兴", "北大暑校", "暑期学校", "DID 双重差分", "RDD 断点回归", "工具变量 IV", "instrumental variable", "计量经济学", "因果推断", "公选课测评", "因果识别方法详细", "PKU summer school", "北京大学 暑期学校", "现代农学院", "本研合上", "小班教学", "difference in differences", "regression discontinuity", "经济学 因果推断", "Rubin causal model", "潜在结果框架", "计量方法对比", "计量方法详解", "Stata 计量", "R 计量", "应用计量", "实证方法 课程"]
date: 2023-07-18
discipline: "经济学"
course: "计量因果识别方法"
material_type: "课程测评"
...
![教学网选课界面显示小组成员含光华管理和教务部等多院校角色](/files/images/causal-id-review-2023/01.jpg)
<p class="img-caption">教学网名单里突然冒出一溜「教务部」角色——后来才知道是北大暑校面向校外开放的标记。</p>
...
![《计量经济学因果识别方法详解》课程讲义封面，黄开兴，北京大学，2023年7月](/files/images/causal-id-review-2023/02.jpg)
<p class="img-caption">课程讲义封面：黄开兴老师，北大现代农学院，2023 年 7 月。</p>
...
![课程内容介绍，列出 DID、RDD、IV 三种因果识别方法的课程大纲摘要](/files/images/causal-id-review-2023/03.jpg)

<p class="img-caption">课程内容介绍</p>

这门课的考核方式也是比较简单的，

![课程总评构成说明，课堂表现占50%、个人汇报占50%](/files/images/causal-id-review-2023/04.jpg)

<p class="img-caption">课程考核方式</p>
