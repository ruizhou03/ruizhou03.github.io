...
keywords: ["数据科学的 Python 基础课程测评", "数据科学的 Python 基础", "Python 数据科学", "Python data science", "阮敬", "光华 Python", "Python 编程基础", "数据可视化", "pandas numpy", "jupyter notebook", "Python 开卷考", "Python 数据分析基础", "Python 课怎么样", "首都经济贸易大学", "首经贸 阮敬", "Anaconda", "matplotlib", "scikit-learn", "本研合上", "大二上 学院核心课", "Python 入门课", "Python 期末 91 题", "二十大报告 词云", "词云图 Python", "面向对象编程 Python", "光华核心课", "Python 数据预处理", "数据描述 EDA"]
date: 2023-01-09
discipline: "计算机"
...
《数据科学的 Python 基础》是 **2021 级**起的学院培养计划中大二上的学院核心课，同时也是一门本研合上课程，由现任**首都经济贸易大学研究生院副院长**阮敬教授开课。

![阮敬老师的个人简介页面，现任首都经济贸易大学研究生院副院长](/files/images/python-ds-review-2023/01.jpg)

这门课每周 3 学时，12 周结课，记 2 学分。值得指出的是，课程有参考书《Python 数据分析基础》，为阮敬老师编著，目前已更新至第三版（但亲测第二版够用，干货满满）。

![课程参考书《Python 数据分析基础》第二版与第三版封面及数据科学书籍](/files/images/python-ds-review-2023/02.jpg)
...
> 2. 考试系统会对你的答题情况进行自动识别，包括但不限于 IP 地址识别、页面切换识别等。如出现考试违规情况，系统自动将考试成绩作废，请自觉遵守考试纪律。
> 3. 本次考试为开卷考试，开卷材料仅限纸质材料。除了手机答题之外，禁止使用 ipad、电脑等其他电子设备。
...
![期末考试第一题：询问本学期任课老师是谁的选择题（含幽默选项）](/files/images/python-ds-review-2023/03.jpg)
...
![以二十大报告关键词生成的词云图，“发展”“人民”“中国”等词汇突出](/files/images/python-ds-review-2023/04.jpg)

生动传神的点睛之笔也能恰到好处地加深我们的理解和印象。比如讲到散点图和线性回归拟合直线时，当**散点紧密团结在以 45°线为核心的 QQ 图**中时，说明拟合效果良好。

![课堂示例：散点紧密分布在45度线附近的QQ图，表明拟合效果良好](/files/images/python-ds-review-2023/05.jpg)
...
![自编Python类gsmer的代码示例，用光华学生属性演示面向对象编程](/files/images/python-ds-review-2023/06.jpg)

对于数据处理部分，不妨自力更生，我用了寒号近一年的数据掌握了 numpy、pandas、matplotlib 等的用法。一开始挺痛苦的，但掌握技能后能感受到些许成就感。

![用pandas读取Excel文件后的数据框预览，含公众号各渠道阅读数据](/files/images/python-ds-review-2023/07.jpg)
