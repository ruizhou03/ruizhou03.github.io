...
keywords: ["微波炉加热原理", "微波炉", "microwave", "微波炉怎么用", "微波炉热饭", "微波加热不均", "冷点热点", "微波炉解冻", "解冻很慢", "微波炉能放金属吗", "微波炉打火", "微波炉容器", "微波炉爆沸", "超热现象", "2.45 GHz", "非电离辐射", "微波炉辐射", "微波炉致癌吗", "水分子偶极子", "微波炉禁忌", "什么不能微波", "微波炉功率"]
---
...
微波炉发出的是 **2.45 GHz 电磁波**——和 WiFi 2.4 GHz 频段几乎重合的微波，仍属于**非电离辐射**。这个波在食物里干一件事：**让水分子以每秒 24.5 亿次的速度试图反复翻转方向**。水分子在拥挤的环境里翻不过来，能量全变成热——这就是加热的本质。
...
<p class="img-caption">微波腔内的标准模式（mode）：四个角落附近往往是热点，正中心是冷点。这就是为什么把食物放在转盘<strong>外圈</strong>比放在中心更容易加热透。</p>
...
微波是**非电离辐射**——光子能量约 $10\,\mu\text{eV}$，远低于打断化学键所需的几个 eV。它不会改变 DNA、不会致癌。
