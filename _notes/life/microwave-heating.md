...
keywords: ["微波炉是怎么把食物加热的？怎么用才对？", "1 水分子是个偶极子", "2 微波就是高速翻转的电场", "3 为什么是 2.45 GHz？", "4 为什么会有冷点热点", "5 为什么金属会打火？", "6 冰为什么解冻这么慢？", "7 超热水的爆沸", "1 容器选择", "2 不同食物的加热策略", "3 空间分布技巧", "4 一定不能微波的", "5 功率与静置时间", "6 关于「微波炉辐射致癌」", "H₂O"]
---
