...
keywords: ["美国手机卡", "手机套餐", "话费套餐", "phone plan", "运营商", "carrier", "MVNO", "虚拟运营商", "Mint Mobile", "Visible", "US Mobile", "T-Mobile", "Verizon", "AT&T", "Google Fi", "Cricket", "Boost Mobile", "Spectrum Mobile", "Metro by T-Mobile", "prepaid 预付费", "postpaid 后付费", "eSIM", "实体 SIM", "保留中国号码", "保号套餐", "WiFi calling", "家庭计划", "隐形税费 taxes fees", "porting 转网", "FCC 信号覆盖", "美国选号", "美国手机话费", "留学生手机卡推荐"]
---
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 760 360" style="max-width:100%;height:auto;display:block;margin:1.2em auto;">
  ...
  <g transform="translate(40, 165)">
    ...
    <text x="14" y="146" font-size="9" fill="#888">(Visible 是同一家 Verizon</text>
    <text x="14" y="156" font-size="9" fill="#888">的便宜版子品牌)</text>
  </g>
  ...
  <g transform="translate(280, 165)">
    ...
    <text x="14" y="146" font-size="9" fill="#888">(Mint 已被 T-Mobile</text>
    <text x="14" y="156" font-size="9" fill="#888">收购，独立运营)</text>
  </g>
  ...
  <g transform="translate(520, 165)">
    ...
    <text x="14" y="146" font-size="9" fill="#888">(Cricket 是同一家 AT&amp;T</text>
    <text x="14" y="156" font-size="9" fill="#888">的便宜版子品牌)</text>
  </g>
