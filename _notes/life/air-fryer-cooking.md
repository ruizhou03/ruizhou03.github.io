...
keywords: ["空气炸锅是怎么工作的？怎么用才对？", "1 空气炸锅的内部构造", "2 模拟油炸口感的两步 水跑光 + 美拉德", "3 油在空气炸里干什么？", "4 和其他烹饪方式的传热对比", "spray bottle", "acrylamide", "一个带高速风扇的小型烤箱", "焦糖化", "水分", "风量", "腔小 + 风快", "油把食物表面的水分迅速汽化掉", "美拉德反应", "多多少少都要给食物加点油"]
---
