...
1. **没信用记录被拒** —— 要么 co-signer 要么找留学生 friendly 的公寓
2. **押金被扣 / 拿不回来** —— 入住前必须 walk-through 拍照 / 退租前清理 + 拍照存证
3. **Lease 合同没读** —— 8 条必看（详见 §7），违约金可能是 2 个月房租

# 3. 4 类住房选择

## 3.1 大型公寓集团（Apartment Complex / Property Management Company）

**美国最常见的租房形式**——大型房产公司持有数百到数千套公寓，统一管理。常见品牌：

- **Greystar**（全美最大，~750K 套）
- **Equity Residential**
- **AvalonBay Communities**
- **Camden Property Trust**
- **大学城本地公寓**（Penn State 周边的 Calder Square / The Park / Beaver Hill 等）

**特点**：

- ✅ **流程标准 / paperless**：在线申请 / DocuSign 签约 / ACH 自动扣款 / portal 报修
- ✅ **Amenities 丰富**：gym / pool / 包垃圾 / 包水
- ✅ **Lease 标准化**：合同条款 industry-standard
- ❌ **要信用 / 收入证明**：通常 credit score ≥ 650 + 月收入 ≥ 3x 房租
...
个人或小型 LLC 持有的独栋 / townhouse / 小型公寓楼。Penn State 周边 State College 镇上很多。
...
- ✅ **灵活**：房东可以根据你情况谈
- ✅ **空间大**：通常 2B+，适合合租
- ❌ **流程不标准**：纸质支票 / 个人沟通 / 房东自己处理报修
- ❌ **维修慢 / 质量参差**
- ❌ **押金返还可能扯皮**：法律上有保护但执行成本高

**适合**：愿意 trade off 标准化 → 价格便宜 / 有合租伙伴 / 喜欢 house。

## 3.3 室友合租 / Shared Room（Roommates）

**最便宜的路径**——3-5 人合租一套 3B-4B house。
...
**合约期内的房客把房子转租给别人**——多见于暑假 / 学期间 / 学生短期回国。

**特点**：

- ✅ **短期** / **价格弹性大**
- ✅ **no application needed**（多数情况）
- ✅ **不用 commit 12 个月**
- ❌ **法律上需要原房东批准**——很多 lease 禁止 sublease
- ❌ **房东不一定知道你住在那**

**适合**：暑期实习 + 寒假短住 + 第一年试水某城市。

# 4. 找房渠道全清单

| 渠道 | 强项 | 适合 | 坑 |
|---|---|---|---|
| **[Zillow](https://www.zillow.com/)** | 最全 + 地图直观 + 私人房东多 | 全美通用 | 数据偶尔过期 |
| **[Apartments.com](https://www.apartments.com/)** | 大型公寓集团最齐 | 标准化公寓 | 偏向大公司 |
| **[Trulia](https://www.trulia.com/)** | 邻里 + 安全数据强 | 在意社区氛围 | 同 Zillow（同公司）|
...
- **第一周**：**Zillow + Apartments + Penn State Off-Campus Living** 三处一起搜
- **第二周**：实地 tour 3-5 个 + 加一个 Facebook Marketplace 转租兜底
- **关键**：**先看实地再签合同**——网上漂亮的图可能藏着旁边垃圾桶 / 高速噪音
...
- **信用分（FICO Score）**：通常 ≥ 650（高端 luxury 要 ≥ 720）
- **月收入**：通常 ≥ **3x 月租**（$1,500 月租 = $4,500 月收入证明）
...
## 6.3 Co-signer / Guarantor

**Co-signer**（共同签约人 / 担保人）：

- 必须是**美国身份 + 信用 700+ + 收入 4x 月租**的人
- 父母（如果在美国）/ 配偶 / 朋友
- **法律责任连带**：你违约，co-signer 要赔
- 多数情况下：**只签字，不实际付钱**

**Guarantor 服务**（如 [TheGuarantors](https://www.theguarantors.com/) / Insurent）：

- 你付**约 1 个月房租**作为服务费
- 服务公司当 co-signer
- 适合：父母不在美国 + 找不到 co-signer 的留学生
- 仅在 NYC / SF / Boston 等大城市有

# 7. Lease 合同必看 8 条

签 lease 前**逐条读完这 8 条**——它们决定你未来 12 个月的核心权利义务：

## 7.1 押金（Security Deposit）返还条款

- 通常 **1-2 个月房租**
- 多数州法律：**30-60 天内退还**
- **要看清”扣什么“的条款**：clean fee / damage / 未付 utilities

**PA 法律**：押金 ≤ 第一年 2 个月房租 + 第二年起 ≤ 1 个月房租 + 房东必须 30 天内返还。

## 7.2 月租 + 锁定期 + Renewal Increase

- 12 个月内**月租锁定**——房东不能涨
- Renewal 时**可以涨**（通常 5-10%）
- **关键**：renewal 涨幅在 lease 上是否写明上限？
...
- 提前解约 → 赔 **2 个月房租**或**剩余房租总额**（哪个少）
- 部分 lease 有 **early termination clause**：付 1-2 个月罚金即可解约
- **没条款的话**：你赔到房东重新出租为止
...
- **月对月**（month-to-month）选项？通常租金涨 10-30%
- **续 12 个月**——常常自动加 5-8%
- **不续**——通常需要 60 天通知

# 8. 入住 Walk-Through + Utilities Setup

## 8.1 入住前 Walk-Through（极其重要）

**入住第一天，房东 / property manager 应该陪你 walk-through**：
...
1. **每个房间逐个检查**：
    ...
    - 浴室 / 马桶 / 水龙头 是否漏水
    - 窗户 / 门锁 是否好用
2. **填 walk-through form**：列出所有现存问题
3. **拍照 / 视频存证**——每个问题清楚拍下来
4. **房东 / 你双签 walk-through form** + 各持一份
5. **手机相册存证**——这是你**未来要押金**的核心证据

**没做 walk-through = 退租时房东可以编任何 damage 扣你押金**。

## 8.2 Utilities 设置（搬入后第一周）
...
3. **Water**（如果不含）：
    - 通常找当地 township / city water department
...
- **典型 lease**：搬出前 **30-60 天书面通知**
- **没通知 / 通知晚 = 自动续约或赔款**
- 通知方式：邮件 / 信件 / lease portal——**留证据**
...
- 退租日 / 退租前**约房东 walk-through**
- 拍照 / 视频对比入住时
- 任何 damage：房东可扣
- **30-60 天内 itemized list + 余款**到你新地址
- **没 itemized list = 房东无理由扣，你可投诉**
...
## 10.2 父母在国外当 co-signer 行吗

**不行**——co-signer 必须**美国境内 + 美国信用历史**。父母在国内是无效 co-signer。

**替代**：

- 父母直接**预付一年房租**（lump-sum payment）—— 房东多数同意
- 用 Guarantor 服务（如 TheGuarantors）—— 付约 1 个月房租

## 10.3 配偶 / F-2 同住

- F-2 不能工作 = 没收入证明
- F-1 主申请人**单独 application**
- 配偶名字可以写在 lease 上当 occupant，**不是 tenant**
...
- 你 / 室友违约 → co-signer 要赔
- co-signer 信用受损
- 法律上 co-signer **完全等同 tenant**——房东可以直接告 co-signer
