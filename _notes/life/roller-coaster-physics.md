...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 680 360" style="max-width:100%;height:auto;display:block;margin:1.4em auto;">
  ...
  <text x="28" y="180" text-anchor="middle" font-size="11" fill="#666" transform="rotate(-90 28 180)">能量 / 高度</text>
  ...
  <text x="245" y="270" font-size="11" fill="#444">谷底：速度最快</text>
  <text x="380" y="330" text-anchor="middle" font-size="11" fill="#c0504d" font-weight="600">红色虚线＝总机械能，因摩擦/空气阻力只降不升</text>
  <text x="560" y="248" font-size="11" fill="#444">越往后能用的“高度预算”越少</text>
</svg>
<p class="img-caption">蓝线是轨道高度剖面，车在它上面跑：低处快、高处慢。红色虚线是这列车手里的**总机械能**，因为摩擦和空气阻力，它只会一路往下滑——这就是为什么没有任何一个后坡能高过第一个坡。</p>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 720 300" style="max-width:100%;height:auto;display:block;margin:1.4em auto;">
  <text x="360" y="22" text-anchor="middle" font-size="14" fill="#333" font-weight="600">同一个人，同一个重力，三处“视重”完全不同</text>
  <!-- valley -->
  <g>
    <path d="M40,110 Q120,210 200,110" fill="none" stroke="#bbb" stroke-width="3"/>
    <rect x="108" y="150" width="24" height="30" rx="3" fill="#5a8fc0"/>
    <line x1="120" y1="150" x2="120" y2="110" stroke="#2e7d32" stroke-width="3" marker-end="url(#au)"/>
    <line x1="120" y1="180" x2="120" y2="225" stroke="#888" stroke-width="2.5" marker-end="url(#ad)"/>
    <text x="120" y="252" text-anchor="middle" font-size="12" fill="#333" font-weight="600">谷底</text>
    <text x="120" y="270" text-anchor="middle" font-size="11" fill="#2e7d32">支持力 ＞ 重力 → 重（4–6 g）</text>
    <text x="148" y="135" font-size="10" fill="#2e7d32">座椅猛顶</text>
  </g>
  <!-- crest -->
  <g>
    <path d="M270,180 Q360,80 450,180" fill="none" stroke="#bbb" stroke-width="3"/>
    <rect x="348" y="118" width="24" height="30" rx="3" fill="#5a8fc0"/>
    <line x1="360" y1="118" x2="360" y2="98" stroke="#2e7d32" stroke-width="3" marker-end="url(#au)"/>
    <line x1="360" y1="148" x2="360" y2="200" stroke="#888" stroke-width="2.5" marker-end="url(#ad)"/>
    <text x="360" y="252" text-anchor="middle" font-size="12" fill="#333" font-weight="600">坡顶</text>
    <text x="360" y="270" text-anchor="middle" font-size="11" fill="#c0504d">支持力 ＜ 重力 → 发飘、失重</text>
    <text x="388" y="108" font-size="10" fill="#c0504d">座椅几乎托不住</text>
  </g>
  <!-- drop / airtime -->
  <g>
    <path d="M520,90 Q600,90 660,210" fill="none" stroke="#bbb" stroke-width="3"/>
    <rect x="566" y="120" width="24" height="30" rx="3" fill="#5a8fc0"/>
    <line x1="578" y1="120" x2="578" y2="150" stroke="#c0504d" stroke-width="3" marker-end="url(#ad2)"/>
    <line x1="578" y1="150" x2="578" y2="200" stroke="#888" stroke-width="2.5" marker-end="url(#ad)"/>
    <text x="590" y="252" text-anchor="middle" font-size="12" fill="#333" font-weight="600">猛扎下坡</text>
    <text x="590" y="270" text-anchor="middle" font-size="11" fill="#c0504d">压杠反过来“拉”你 → 抛飞感（负 g）</text>
    <text x="600" y="112" font-size="10" fill="#c0504d">压杠拽住你</text>
  </g>
  <defs>
    ...
    <marker id="ad" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="6" markerHeight="6" orient="auto"><path d="M0,0 L5,10 L10,0 z" fill="#888"/></marker>
...
<p class="img-caption">绿色／红色箭头是座椅或压杠施加的力，灰色向下箭头是始终不变的重力。三处重力一模一样，但**顶你的那个力**差别巨大——身体感觉到的“轻重”，全是它说了算。</p>
