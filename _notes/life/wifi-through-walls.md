...
<p class="img-caption">**dB 是对数刻度**：每 $+10$ dB 信号强度衰减 10 倍、$+20$ dB 衰减 100 倍。一堵混凝土承重墙（5G $\approx 18$ dB）就能把信号衰减到原来的 $1/63$。两堵承重墙叠加 36 dB，相当于 $1/4000$——这就是为什么穿两堵墙基本就什么都不剩了。**5 GHz 的衰减普遍是 2.4 GHz 的 $1.5$-$2$ 倍**。</p>
