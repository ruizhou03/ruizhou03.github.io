...
keywords: ["美国签证", "签证类型", "visa", "F-1", "学生签证", "F-2", "J-1", "访问学者", "J-2", "OPT", "STEM OPT", "CPT", "H-1B", "工作签证", "O-1", "L-1", "TN 签证", "绿卡", "green card", "EB-2", "EB-3", "身份转换", "签证能做什么", "F1 签证"]
---
...
**能做：**
- 在录取学校全日制读书
- **校内打工**（学期内 $\leq 20$ 小时/周；假期 $\leq 40$ 小时/周；TA / RA / 食堂 / 图书馆 / IT helpdesk 等都算校内）
...
| **Short-term Scholar** | 短期访问研究 | $\leq 6$ 个月 |
...
- **形式：** 毕业后 12 个月的 EAD，可以全职、不限雇主、可以 unemployed 累积 $\leq 90$ 天
...
- **触发：** 必须在海外公司全职工作 $\geq 1$ 年（最近 3 年内）
...
- 实务中签证页通常合并为 **B-1/B-2**
- **典型停留：** 每次入境 6 个月（实际由海关定）；签证有效期 $\leq 10$ 年（中国十年签证就是 B-1/B-2）
...
| **O-1** | ✅ | 多雇主灵活 | O-3 ❌ | 门槛高 |
| **L-1** | ✅ | 同公司美国分支 | **L-2 EAD 自动 ✅** | 海外公司必须 $\geq 1$y |
