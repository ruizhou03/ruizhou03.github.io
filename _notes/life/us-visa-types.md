...
keywords: ["美国签证完全指南 从 F-1 到绿卡，每种身份能做什么、不能做什么", "这篇文章给谁看", "全景图", "学生与学者签证（F、J）", "1 F-1 学生签证（最常见）", "2 F-2 家属签证", "4 J-2 家属签证", "学习期间的工作豁免", "3 STEM OPT（24 个月延长）", "工作签证（毕业后）", "1 H-1B（最常见）", "2 O-1 杰出人才", "3 L-1 跨国公司内调", "4 TN（加拿大、墨西哥专属）", "5 E-3（澳大利亚专属）"]
---
