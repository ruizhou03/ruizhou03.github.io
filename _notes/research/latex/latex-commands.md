...
published: true
keywords: ["LaTeX 快捷键", "LaTeX 自定义命令", "newcommand", "renewcommand", "commands.tex", "LaTeX 宏定义", "数学符号简写", "mathbb 数集", "自动伸缩括号", "left right 括号", "可选参数 默认值", "DeclareMathOperator", "算子定义", "草稿 TODO 宏", "LaTeX macros", "amsmath", "aligned cases 简写", "写公式提速", "LaTeX 偷懒", "Latex 快捷键"]
---
