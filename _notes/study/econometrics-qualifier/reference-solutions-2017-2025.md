...
title: "2017–2025 Econometrics Qualifying Exams and Answers"
list_title: "2017–2025 Econometrics Qualifying Exams and Answers"
keywords: ["econometrics qualifier solutions", "博资考 参考答案", "Penn State econometrics past exams", "ECON 501 solutions", "ECON 510 solutions", "qualifying exam worked solutions", "计量资格考 题解"]
discipline: "经济学"
course: "高级计量经济学（PSU）"
material_type: "Exams"
...
pdf_url: "/files/adv-metrics-psu/econometrics-qualifying-exams-and-answers-2017-2025.pdf"
summary: "Penn State 2017–2025 Econometrics Qualifying Exams 官方原卷入口与非官方学生参考解答：94 个题目标签、中文识题思路、英文推导和易错点。"
published: true
trashed: false
---

本站 PDF 是学生整理的非官方 answers，不代表系里或任课教师。原始 exams 直接链接 Penn State Department of Economics 的公开文件：
...
2021 年公开扫描只有两页，缺失题面没有补写。系里的完整入口是 [Ph.D. Qualifier Exams](https://econ.la.psu.edu/ph-d-program/ph-d-qualifier-exams/)。配套阅读：[Qualifying Exam Cheat Sheet]({{ '/notes/econometrics-qualifier/cheat-sheet' | relative_url }})｜[ECON 501 Handbook]({{ '/notes/econometrics-qualifier/econ-501-handbook' | relative_url }})。
