...
Regardless what perspective we take to analyze the market, the central idea is invariant: the market should clear. Typically, we differentiate between partial equilibrium and general equilibrium. From the perspective of partial equilibrium, we suppose the prices of all other goods are held fixed, and then analyze the equilibrium in a single market. From the general equilibrium's perspective, in contrast, we extend our focus to all markets and require all markets clear simultaneously.\\

\noindent Superficial as the partial equilibrium may seem when juxtaposed with general equilibrium, the approach of partial equilibrium analysis is still powerful typically in cases where
\begin{itemize}
  \item
    The prices of the goods in all other markets are held fixed; or more precisely, the effect on the prices of all other goods can be neglected.
  \item
    No wealth effect of the market of interest.
  \end{itemize}
...
\hypertarget{pure-exchange-economy}{%
\section{Pure Exchange Economy}\label{pure-exchange-economy}}

Traditionally in analysis of a market, there are three central activities of interest: consumption, production and trade. While in pure exchange economy, each agent has an endowment that they can trade with, and there is no production; we only care about the exchange of goods.
...
\item
  The equilibrium allocation is Pareto eﬀicient.
\end{enumerate}

\hypertarget{basic-setups-2}{%
...
\hypertarget{walrasian-equilibrium}{%
...
Recap on what we have learned in intermediate microeconomics:
\begin{itemize}
\item
  First theorem of welfare economics: Any Walrasian equilibrium is
  Pareto efficient.
\item
  Second theorem of welfare economics: By adjusting the initial
  endowments. any Pareto efficient allocation can be supported by a
  Walrasian equilibrium.
\end{itemize}

Before we delve deep into discussions on allocation, a rigorous definition of feasible allocation is helpful.
...
Feasible allocation requires that, the total allocation for any good cannot be more than the total
initial endowment.
...
Under Pareto efficient allocation, there is no way to make any agent
strictly better off without harming some other agent(s).
...
Core allocation requires that, no group of agents would simultaneously form a blocking coalition in which none is made worse off and some strictly better off. Notice that an allocation being in the core implies it being Pareto efficient, but the converse is not necessarily true. Indeed, when examining Pareto efficiency, we are checking the possibility of grand blocking coalition.
...
\begin{itemize}
\item
  \(S_W\subseteq S_P\) is indicated in \textit{First Theorem of Welfare Economics}.
\item
  \(S_W\subseteq S_C\) implies that any Walrasian equilibrium is not only Pareto efficient, but also fair, which is a justification for the price mechanism.
\item
  The strengthened First Theorem of Welfare Economics need very minimal requirements on the agents' preference
  relations, but assumptions on perfect competition, complete information, no
  externality and complete markets are indispensable.
\end{itemize}
}
...
However, the second theorem of welfare economics is less exciting,
because the government can neither arbitrarily redistribute initial endowments, nor know each agent's preferences in the economy.

\hypertarget{ge-with-production}{%
...
That is, in Walrasian equilibrium all markets clear at the same time, with all consumers (also shareholders of firms) and firms optimize their goals simultaneously.

The essence of Walrasian equilibrium with production is the same as that without production. But for concerns of technical issues, we introduce three additional assumptions on production technology to pave way for the theorem of existence of Walrasian equilibrium with production.
...
\hypertarget{existence-of-walrasian-equilibrium-with-production}{%
\subsection{Existence of Walrasian Equilibrium with
Production}\label{existence-of-walrasian-equilibrium-with-production}}
