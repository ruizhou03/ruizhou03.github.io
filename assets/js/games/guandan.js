(() => {
  ...
  const GD_BUILD = '2026.06.16.8';  // 版本号：每次改动递增；刷新后看左下角徽标即可确认已加载最新版（含 AI 引擎状态）
  const SUIT_LABELS = ['♠','♥','♦','♣'];
  ...
  const SUITP = {
    ...
    0: { tr: 0.335, bl: 0.34, big: 1.13, br: -0.08, bb: -0.045, op: 1,   bigH: 0.97, brH: -0.105, bbH: 0.055,  opH: 1,   trY: 0.02, blY: -0.175 },
    1: { tr: 0.19,  bl: 0.2,  big: 0.6,  br: 0.17,  bb: 0.245,  op: 1,   bigH: 0.6,  brH: 0.04,   bbH: 0.2,    opH: 1,   trY: 0,    blY: -0.2 },
    2: { tr: 0.22,  bl: 0.22, big: 0.71, br: 0.115, bb: 0.19,   op: 0.9, bigH: 0.71, brH: -0.01,  bbH: 0.15,   opH: 0.9, trY: 0,    blY: -0.2 },
    3: { tr: 0.325, bl: 0.34, big: 1.04, br: -0.04, bb: -0.015, op: 0.9, bigH: 0.96, brH: -0.02,  bbH: -0.045, opH: 1,   trY: 0,    blY: -0.17 },
  };
