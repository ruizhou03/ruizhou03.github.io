...
assert.match(html, /guandan\.js\?v=20260723rules1/, '生产页面应使用规则合同内容标记，避免旧 JS 缓存');
...
assert.match(js, /gd-huaian-2025-site-v1/, '前端必须声明不可变 rulesVersion');
assert.match(js, /guandan-protocol-v2/, '前端必须声明 protocolVersion');
